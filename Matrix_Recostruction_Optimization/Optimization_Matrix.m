...
diff_MX = sum(sum(abs(MX_end-set.MX_mad_end).^2)) + sum(sum(abs(MX_mid-set.MX_mad_mid).^2)) + ...
...
diff_MY = sum(sum(abs(MY_end-set.MY_mad_end).^2)) + sum(sum(abs(MY_mid-set.MY_mad_mid).^2)) + ...
